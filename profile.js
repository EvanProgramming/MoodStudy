...
const interactiveElements = document.querySelectorAll('button, a, .ap-tag, .segmented__btn, .range__input, .text-input');
...
const observer = new MutationObserver(() => {
  const newElements = document.querySelectorAll('button, a, .ap-tag, .segmented__btn, .range__input, .text-input');
